...
public class SimpleSyncIntenService extends SyncIntenService {
    ...
    protected void onHandle(Intent intent) {
        ...
        serviceLocalDataRepository.getDatosExportarGlobal(new ServiceLocalDataRepository.CallBack<BEGuardarEntidadesGlobal>() {
            ...
            public void onResponse(boolean success, BEGuardarEntidadesGlobal item) {
                if(success){
                    serviceRemoteDataRepository.SendDatosGlobalSimple(item, new ServiceRemoteDataRepository.RespuestaCallBack<BEGuardarEntidadesGlobal, BERespuesta>() {
                        @Override
    ...
    public static void start(Context context){
        Intent msgIntent = new Intent(context, SimpleSyncIntenService.class);
