...
public class SaveGEDatosListRubroEvaluacionProcesoImport extends UseCase<SaveGEDatosListRubroEvaluacionProcesoImport.RequestValues, SaveGEDatosListRubroEvaluacionProcesoImport.ResponseValue> {

    private GEDatosRubroEvaluacionProcesoRepository repository;

    public SaveGEDatosListRubroEvaluacionProcesoImport(GEDatosRubroEvaluacionProcesoRepository repository) {
    ...
    protected void executeUseCase(RequestValues requestValues) {
        ...
        repository.getDatosImportarPorCalendarioPeriodo(beVariables, new ServiceDataSource.ObjectCallBack<GEDatosRubroEvaluacionProceso>() {
            @Override
