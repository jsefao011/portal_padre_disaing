...
public class SaveBEDatosEnvioGrupoImport extends UseCase<SaveBEDatosEnvioGrupoImport.RequestValues, SaveBEDatosEnvioGrupoImport.ResponseValue> {

    private BEDatosEnvioGrupoRepository repository;

    public SaveBEDatosEnvioGrupoImport(BEDatosEnvioGrupoRepository repository) {
    ...
    protected void executeUseCase(RequestValues requestValues) {
        ...
        repository.getDatosImportar(beVariables, new ServiceDataSource.ObjectCallBack<BEDatosEnvioGrupo>() {
            @Override
