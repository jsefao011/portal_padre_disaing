...
public class OfficialMessage extends BaseModel {
    ...
    public OfficialMessage(String id, String subject, String title, String reference1, String reference2, String reference3, String reference4, String importantReference, String officialEmisorName, String actionType, int state, long actionTimestamp) {
        this.id = id;
        this.subject = subject;
        this.title = title;
        this.reference1 = reference1;
