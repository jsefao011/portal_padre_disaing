...
public abstract class BasePresenterImpl<V extends com.consultoraestrategia.ss_crmeducativo.portal.base.activity.BaseView> implements BasePresenter<V> {
    ...
    @Override
    public void onMultiItemsSelectedFilter(Object o) {
