package com.consultoraestrategia.ss_crmeducativo.portal.tareas.tareasGenerales.presenter;
...
import com.consultoraestrategia.ss_crmeducativo.portal.tareas.tareasGenerales.view.TareaGeneralesView;
...
public class TareaGeneralesPresenterImpl extends TabsTareasListPresenterImpl implements TareaGeneralesPresenter{
    TareaGeneralesView view;

    public TareaGeneralesPresenterImpl(UseCaseHandler handler, GetTareasCursoAlumno getTareasCursoAlumno) {
        super(handler, getTareasCursoAlumno);
    }
    @Override
    public void attachView(TabsTareasListaView view) {
        super.attachView(view);
        this.view= (TareaGeneralesView) view;
    }
    ...
    private void initC() {
        ...
        if(view!=null)  view.showTabletareasGenerales(fila, columna, cellslists);
