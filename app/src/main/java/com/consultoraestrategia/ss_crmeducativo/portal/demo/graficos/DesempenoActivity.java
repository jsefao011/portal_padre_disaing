...
public class DesempenoActivity extends AppCompatActivity {
    ...
    @BindView(R.id.horizontal_progress_barTr5)ProgressBar progressBarCapacidad5;
    ...
    private void setTextOne(final String value) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                textViewCountProgres.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.md_yellow_900));
            }
        });
    }
